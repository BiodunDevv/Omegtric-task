...
export function SearchFilter({
  ...
  return (
    <div className="rounded-xl bg-white px-4 py-3 border-b border-slate-100">
      <div className="flex items-center gap-4">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 bg-[#ebebeb] border-0 shadow-none text-sm h-10 rounded-lg placeholder:text-muted-foreground focus-visible:ring-0"
          />
        </div>
        <div className="flex items-center gap-4 bg-[#ebebeb] h-10 px-3 rounded-lg">

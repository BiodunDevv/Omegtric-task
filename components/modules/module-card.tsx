...
function AdminStatusBadge({ module }: { module: Module }) {
  switch (module.adminStatus) {
    case "active":
      return (
        <div className="inline-flex gap-2.5 rounded-sm bg-[#EAFFEF] px-3.5 py-3 w-[300px]">
          <CheckCircle2 className="size-3.5 shrink-0 text-green-600 mt-0.5" />
          <div>
            <p className="text-[12px] font-semibold text-[#09B223] leading-tight">
              Active
            </p>
    ...
    case "invite-sent":
      return (
        <div className="inline-flex gap-2.5 rounded-sm bg-blue-50 px-3.5 py-3 w-[300px]">
    ...
    case "expired":
      return (
        <div className="inline-flex justify-between gap-2.5 rounded-sm bg-red-50 px-3.5 py-3 w-[300px]">
    ...
    case "inactive":
      return (
        <div className="inline-flex justify-between gap-2.5 rounded-sm bg-gray-100 px-3.5 py-3 w-[300px]">
          <div className="flex gap-2">
    ...
    <Card className="px-5 py-4">
      <div className="flex items-start justify-between">
        <div className="flex items-start gap-3">
          <div className="flex size-10 shrink-0 items-center justify-center rounded-md bg-slate-100">
            <Layers className="size-5 text-[#1A41BF]" />
          </div>
            ...
            <Badge
              className={
                module.status === "active"
                  ? "bg-[#BCE5C345] text-[#09B223] hover:bg-green-100 text-[11px] px-2 py-0"
      ...
      <div className="ml-12">
        <div className="flex justify-between">
          ...
          <div className="flex items-end justify-end gap-4 text-[12px] text-muted-foreground">
        ...
        <div className="mt-3 flex justify-between">
          ...
          <div className="flex flex-col gap-1.5 w-full max-w-[280px] justify-end">
